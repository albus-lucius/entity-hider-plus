...
public class EntityHiderPlusPanel extends PluginPanel
{
	private final EntityHiderPlusPlugin plugin;
	private final JPanel listContainer;
	private final JLabel countLabel;
	private List<EntityHiderPlusPlugin.NpcData> lastDisplayedNpcs = new ArrayList<>();

	public EntityHiderPlusPanel(EntityHiderPlusPlugin plugin)
	{
		super(false);
		this.plugin = plugin;
	...
	public void update(List<EntityHiderPlusPlugin.NpcData> npcs)
	{
		// Sort by name, then by ID
		List<EntityHiderPlusPlugin.NpcData> sorted;
		...
		else
		{
			...
			sorted.sort(Comparator
				.comparing((EntityHiderPlusPlugin.NpcData n) -> n.name)
	...
	private boolean isSameNpcList(List<EntityHiderPlusPlugin.NpcData> a, List<EntityHiderPlusPlugin.NpcData> b)
	{
		if (a.size() != b.size())
		{
			return false;
	...
	private JPanel createNpcRow(EntityHiderPlusPlugin.NpcData npc)
	{
